...
const pages = ['BUS TICKETS', 'MOVIES', 'EVENTS'];
const settings = ['Sign In','Sign Up'];
const manage=['Cancel Ticket','Change Date','Show Ticket','Email/SMS']
        ...
        <Toolbar disableGutters>
          ...
          <Box sx={{ flexGrow: 1, display: { xs: 'none', md: 'flex' } }}>
            {pages.map((page) => (
              ...
              <Button sx={{ my: 2, color: 'white', display: 'block' }} onClick={handleOpenManageMenu}>Manage Booking
                </Button>
              <Menu
              sx={{ mt: '45px' }}
              id="menu-appbar"
            ...
            >
              {manage.map((manage) => (
                <MenuItem key={manage} onClick={handleCloseManageMenu}>
